...
/**
 * @brief Adelson-Velsky and Landis tree: a self-balancing binary search tree.
 *
 * The heights of the child subtrees do not differ by more than one. Upon insertion, rebalancing is
 * done through rotations of subtrees to ensure this property holds true.
 *
...
public:
    ...
    /**
     * @brief Output to stdout a space-delimited list of the values using in-order traversal.
     */
    void print_inorder() const;

    /**
     * @brief Output to stdout a space-delimited list of the values using post-order traversal.
     */
    void print_postorder() const;

    /**
     * @brief Output to stdout a space-delimited list of the values using pre-order traversal.
     */
...
private:
    ...
    /**
     * @brief Balance a sub-tree.
     *
     * @param node The root node of the sub-tree to balance.
     *
    ...
    /**
     * @brief Do a recursive in-order traversal of a tree and output the values to stdout.
     *
    ...
    /**
     * @brief Do a recursive post-order traversal of a tree and output the values to stdout.
     *
     * @param node The root of the tree to traverse.
     */
    ...
    /**
     * @brief Do a recursive pre-order traversal of a tree and output the values to stdout.
     *
     * @param node The root of the tree to traverse.
     */
